...
function printGenericHelp(context, commandsInfo, defaultNumTabs = 1, extraTabLengthThreshold = 5) {
...
function printCommandSpecificHelp(context, commandsInfo, commandName, defaultNumTabs = 1, extraTabLengthThreshold = 5) {
    const command = lookUpCommand(commandsInfo, commandName);
    if (command === undefined) {
...
function printSubcommandSpecificHelp(context, commandsInfo, commandName, subcommandName, defaultNumTabs = 1, extraTabLengthThreshold = 5) {
